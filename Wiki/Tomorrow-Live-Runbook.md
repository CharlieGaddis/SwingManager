...
- New live entries are limited to `09:30-16:00 America/New_York` on weekdays. The monitor may run outside that window, but live submits are skipped/blocked.
- Schwab submit payloads use `session: NORMAL`; entries are intentionally limited to the regular session.
